...
class BusinessVisitView extends StatelessWidget {
  BusinessVisitView({super.key});
    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(
        child: Padding(
          ...
          child: Column(
            children: [
              CustomRequestTitel(subTitle: 'Business Visit Request'),
              ...
              CustomContainerWithTitle(
                ...
                widget: Obx(
                  () => CustomTextFiled(
                    label: requestController.orderDate.value == null
                        ? 'dd/mm/yyyy'
                        : DateFormat(
                            'dd/MM/YYYY',
                          ).format(requestController.orderDate.value!),
      ...
      bottomNavigationBar: Padding(
        ...
        child: Obx(
          () => RowButton(
            extraFields: {
              'Order Date': requestController.orderDate.value != null
                  ? DateFormat(
                      'dd/MM/YYYY',
                    ).format(requestController.orderDate.value!)
                  : '',
